...
class NewHistoryTableViewController: UITableViewController {
    ...
    func loadData(){
        history = NewHistory.sI.dicesList()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        guard let cell = tableView.dequeueReusableCell(withIdentifier: reuseIdentifier, for: indexPath) as? NewHistoryTableViewCell else {
